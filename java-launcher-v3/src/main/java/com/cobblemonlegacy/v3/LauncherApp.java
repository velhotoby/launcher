...
public final class LauncherApp extends JFrame {
    private static final String CURRENT_VERSION = "3.4.23";
    ...
    public static void main(String[] args) {
        ...
        if (args.length == 1 && "--self-test".equals(args[0])) {
            try {
                ...
                if (!UpdateService.isNewer("3.4.24", "3.4.23")
                        || UpdateService.isNewer("3.4.23", "3.4.23")
                        || UpdateService.isNewer("3.4.22", "3.4.23")) {
    ...
    private JPanel createLauncherPanel() {
        ...
        footer.add(label("VERSÃO 3.4.23", MUTED, 9, Font.BOLD), BorderLayout.EAST);
        content.add(footer);
