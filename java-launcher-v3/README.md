# Cobblemon Legacy Launcher 3.4.8

Versão Java multiplataforma do launcher da comunidade.

O visual 3.4.8 reproduz a identidade do site oficial: banner da comunidade, tipografia
...
Compile com `./build.sh`. O resultado é salvo em `../dist/Cobblemon-Legacy-Launcher-3.4.8.jar`.

## Sincronização de mods

A versão 3.4.8 usa `trusted-mod-catalog.json` e não acessa o Google Drive. Os arquivos são
