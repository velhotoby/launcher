# Cobblemon Legacy Launcher 3.4.22

Versão Java multiplataforma do launcher da comunidade.

O visual 3.4.22 reproduz a identidade do site oficial: banner da comunidade, tipografia
...
A versão 3.4.22 detecta a memória física e a quantidade de processadores lógicos antes de iniciar
...
Compile com `./build.sh`. O resultado é salvo em `../dist/Cobblemon-Legacy-Launcher-3.4.22.jar`.
...
A versão 3.4.22 usa `trusted-mod-catalog.json` e não acessa o Google Drive. Os arquivos são
