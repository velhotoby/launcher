# Cobblemon Legacy Launcher 3.4.28

Versão Java multiplataforma do launcher da comunidade.

O visual 3.4.28 reproduz a identidade do site oficial: banner da comunidade, tipografia
...
A versão 3.4.28 detecta a memória física e a quantidade de processadores lógicos antes de iniciar
...
Compile com `./build.sh`. O resultado é salvo em `../dist/Cobblemon-Legacy-Launcher-3.4.28.jar`.
...
A versão 3.4.28 usa `trusted-mod-catalog.json` e não acessa o Google Drive. Os arquivos são
...
Antes de abrir o jogo, a versão 3.4.28 também cria e ativa o pacote local
